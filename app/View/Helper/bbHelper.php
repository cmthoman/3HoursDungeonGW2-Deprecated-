...
class BbHelper extends AppHelper
{
	...
	private $bb_noReplacements = array(
		'\1',
		'\1',
		'\1',
		'\1',
	...
	public function noParse($text){
		...
		while($text != preg_replace($this->bb_tags, $this->bb_noReplacements, $text)) { 
			$text = preg_replace($this->bb_tags, $this->bb_noReplacements, $text);
		} 
